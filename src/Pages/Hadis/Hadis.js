  ...
  return (
    <section className="overflow-y-auto p-5 h-section flex sm:flex-col sm:items-center sm:justify-center">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="border-2 border-color1 rounded-lg ">
        ...
        <button
          onClick={changeHadis}
          className="block w-fit mx-auto select-none bg-primary text-gray-200 bg-opacity-75 hover:bg-opacity-100 px-5 pt-1 pb-1 rounded mt-5 mb-5">
          تغير الحديث
        </button>
