      ...
      <div className="max-w-screen-xl mx-auto pt-5 pb-5">
        ...
        {azkarMorning.map((azkar, i) => (
          <div
            ...
            <span className="bg-primary border border-color2 px-10 pt-2 pb-2 mt-5 rounded-lg text-xl font-bold inline-block text-white">
              {azkar.count} مرات
            </span>
          </div>
        ))}
        ...
        <div className="flex justify-between select-none items-center gap-5 p-3 mt-10">
          <Link
            ...
            <span>
              ...
              الرجوع الى أذكار بعد انتهاء الصلاه
            </span>
          </Link>
          <Link
            to={"/azkar-nome"}
